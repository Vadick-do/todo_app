...
const docTemplate = `{
            ...
            "get": {
                ...
                "responses": {
                    ...
                    "400": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/github_com_Vadick-do_todo_app_internal_core_transport_htpp_responce.ErrorResponse"
                        }
                    },
                    "500": {
    ...
    "definitions": {
        "github_com_Vadick-do_todo_app_internal_core_transport_htpp_responce.ErrorResponse": {
            "type": "object",
            "properties": {
                "error": {
                    "type": "string",
        ...
        "internal_features_tasks_transport_http.CreateTaskResponse": {
            ...
            "properties": {
                ...
                "description": {
                    "type": "string",
                    "example": "Сделать домашку по математике до четверга"
                },
                "id": {
                    "type": "integer",
                    "example": 15
